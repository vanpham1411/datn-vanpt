            ...
            <div class="add-entity">
                <div class="flex">
                    <div class="w-3/5">
                        ...
                        <div class="general-row">
                            <p>Mô tả</p>
                            <textarea :readonly="readonly" class="w-full" rows="2" v-model="product.description"
                                placeholder="">
                            </textarea>
                        </div>
                    </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr v-for="(itemDetail, index) in items" :key="index"
                            ...
                            <td class=""><input :id="'typeName' + index" :readonly="readonly" type="text"
                                    style="text-align: end;" v-model="itemDetail.type.name"></td>
